...
2. (1 minute) Create and share with your team a shared editor (e.g., Google docs, https://pad.riseup.net/, etc.) for notes. If you create an etherpad from riseup.net, make sure you choose its lifespan to be 60 days. 
